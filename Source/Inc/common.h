...
#ifndef _CSAUDIOACP2X_COMMON_H_
#define _CSAUDIOACP2X_COMMON_H_
...
//
//=============================================================================
typedef struct _CSAUDIOACP2X_DEVPROPERTY {
    const DEVPROPKEY   *PropertyKey;
    DEVPROPTYPE Type;
    ULONG BufferSize;
    __field_bcount_opt(BufferSize) PVOID Buffer;
} CSAUDIOACP2X_DEVPROPERTY, PCSAUDIOACP2X_DEVPROPERTY;
...
typedef struct _ENDPOINT_MINIPAIR 
{
    ...
    // Topology miniport.
    PWSTR                           TopoName;               // make sure this or the template name matches with CSAUDIOACP2X.<TopoName>.szPname in the inf's [Strings] section
    ...
    const CSAUDIOACP2X_DEVPROPERTY*       TopoInterfaceProperties;

    // Wave RT miniport.
    PWSTR                           WaveName;               // make sure this or the template name matches with CSAUDIOACP2X.<WaveName>.szPname in the inf's [Strings] section
    ...
    const CSAUDIOACP2X_DEVPROPERTY*       WaveInterfaceProperties;
