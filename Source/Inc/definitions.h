...
#ifndef _CSAUDIOACP2X_DEFINITIONS_H_
#define _CSAUDIOACP2X_DEFINITIONS_H_
...
#define STATIC_PID_CSAUDIOACP2X\
    0x836ba6d1, 0x3ff7, 0x4411, 0x8b, 0xcd, 0x46, 0x95, 0x53, 0x45, 0x2d, 0xce
DEFINE_GUIDSTRUCT("836BA6D1-3FF7-4411-8BCD-469553452DCE", PID_CSAUDIOACP2X);
#define PID_CSAUDIOACP2X DEFINE_GUIDNAMED(PID_CSAUDIOACP2X)

// Pool tag used for CSAUDIOACP2X allocations
#define CSAUDIOACP2X_POOLTAG               'SASM'  

// Debug module name
#define STR_MODULENAME              "CSAUDIOACP2X: "
...
#endif // _CSAUDIOACP2X_DEFINITIONS_H_
