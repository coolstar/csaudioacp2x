...
#pragma code_seg("PAGE")
NTSTATUS
CsAudioAcp2xPropertyDispatch
(
    _In_ PPCPROPERTY_REQUEST PropertyRequest
)
/*++
    Handles and dispatches a CSAUDIOACP2X_PROPERTY_ITEM.

    Use this as the property handler only if the property item is a
    CSAUDIOACP2X_PROPERTY_ITEM.
--*/
{
    PAGED_CODE();

    CSAUDIOACP2X_PROPERTY_ITEM* item = (CSAUDIOACP2X_PROPERTY_ITEM*)PropertyRequest->PropertyItem;
