...
#ifndef _CSAUDIOACP2X_MICARRAYTOPO_H_
#define _CSAUDIOACP2X_MICARRAYTOPO_H_
...
class CMicArrayMiniportTopology :
    public CMiniportTopologyCsAudioAcp2x,
...
public:
    ...
    (
        ...
        CMiniportTopologyCsAudioAcp2x(FilterDesc, DeviceMaxChannels),
...
#endif // _CSAUDIOACP2X_MICARRAYTOPO_H_
