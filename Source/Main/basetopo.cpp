...
CMiniportTopologyCsAudioAcp2x::CMiniportTopologyCsAudioAcp2x
(
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyCsAudioAcp2x::DataRangeIntersection
( 
    _In_  ULONG                 PinId,
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyCsAudioAcp2x::GetDescription
( 
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyCsAudioAcp2x::Init
( 
...
--*/
{
    ...
    DPF_ENTER(("[CMiniportTopologyCsAudioAcp2x::Init]"));
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyCsAudioAcp2x::PropertyHandlerGeneric
(
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyCsAudioAcp2x::PropertyHandlerMuxSource
(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyCsAudioAcp2x::PropertyHandlerDevSpecific(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
VOID
CMiniportTopologyCsAudioAcp2x::AddEventToEventList
(
...
#pragma code_seg()
VOID
CMiniportTopologyCsAudioAcp2x::GenerateEventList
(
    _In_opt_    GUID   *Set,
    _In_        ULONG   EventId,
    _In_        BOOL    PinEvent,
...
--*/
{
    DPF_ENTER(("[CMiniportTopologyCsAudioAcp2x::GenerateEventList]"));
